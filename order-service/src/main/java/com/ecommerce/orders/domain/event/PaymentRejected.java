...
public record PaymentRejected(PaymentId paymentId, OrderId orderId, Instant occurredAt) implements DomainEvent {

    public PaymentRejected(PaymentId paymentId, OrderId orderId) {
