...
public record PaymentApproved(PaymentId paymentId, OrderId orderId, Instant occurredAt) implements DomainEvent {

    public PaymentApproved(PaymentId paymentId, OrderId orderId) {
